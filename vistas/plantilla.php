...
<head>
  ...
  <script src="vistas/plugins/sweetalert2/sweetalert2.all.js"></script>
   ...
   <!-- Select2 -->
  <script src="vistas/plugins/select2/dist/js/select2.full.min.js"></script>
...
<body class="hold-transition skin-blue sidebar-collapse sidebar-mini login-page">
  ...
  ?>
    ...
    <script src="vistas/js/clase.js"></script>
    <script src="vistas/js/curricular.js"></script>
</body>
